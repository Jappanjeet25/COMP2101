...
Options:
    ...
    --domain	Display the domainname
    --ipconfig	Display the IP configuration
    --os	Display the operating system information
    --cpu	Display the CPU information
    --memory	Display the memory information
    --disk	Display the disk usage information
    --printer	Dispaly the printer list
...
#Interrupt (Ctrl+C) and run cleanup
trap cleanup INT
